...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_examples(episode_path):
        ...
        for k, example in enumerate(data):
            ...
            episode = []
            # print(f"DATAAAAAAAAAAAAAAAA {example}")
            print(f"DATAA LANGUAGE {example['language_instruction']}")
            ...
            for i in range(len(example)):
                ...
                for image_idx in range(4):
                    ...
                    if image_idx == 0:
                        ...
                        observation[new_key] = np.zeros_like(example['image'])
...
class ExampleDataset(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        base_paths = ["""/mnt/c/Users/konst/OneDrive/Dokumente/ETH/Jahr 2025 - 2026/Mixed Reality/embodied-CoT-aria/aria_vrs/bridge_rlds_builder-main/example_dataset/data"""]
